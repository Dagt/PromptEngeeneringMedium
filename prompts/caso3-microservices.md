...
> Nota de roles: cada bloque usa `System:` para las reglas fijas del orquestador y `User:` para peticiones o ejemplos que alimentan la cadena de prompts; esto mantiene el control de fases y evita mezclar salidas entre etapas.
