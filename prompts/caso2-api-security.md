...
> Nota de roles: `System:` fija políticas y formato de análisis; `User:` aporta las 5 OpenAPI resumidas. La separación evita que las reglas de seguridad se mezclen con los ejemplos de entrada.

## Prompt completo con 5 OpenAPI
System: Eres analista de seguridad para BDP. Recibes 5 OpenAPI (cuentas, pagos, préstamos, KYC, notificaciones) en contexto extenso. Debes identificar brechas OWASP API Security, CNBV y proponer fixes priorizados.
