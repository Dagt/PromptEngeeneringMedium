...
> Nota de roles: `System:` consolida criterios de versión y métricas; `User:` inyecta casos y ejemplos que gatillan cada iteración. Mantener la distinción permite medir mejoras sin mezclar instrucciones con datos.
